...
def denoiseTV(y,lambd,pin,maxiter=100,L=8,tol=1e-5,optim='fgp',verbose=False,img=[],bounds=[-math.inf, math.inf],bc='reflexive'):
    P = pin
        ...
        for i in range(1, maxiter+1):
            ...
            if verbose:
                if img.size == 0:
                    ...
                    print("%3d \t " % (i) + "%10.5f \t " % (re) + "%10.5f \t " % (fun_val) + "%2.8f\n" % (dual_gap))
